...
OUTPUT FILES
------------
  devops_brain/challenge_pipeline.py             — the new pipeline to review
  devops_brain/competitive/code_review.json      — Sprint 1 findings
  devops_brain/competitive/test_results.json     — Sprint 3 test run
  devops_brain/competitive/slo_priority.json     — Sprint 5 SLO priority
  devops_brain/competitive/scorecard.json        — final verdict + student judgment
...
def print_scorecard(checks: list) -> int:
    ...
    if score == 5:
        ...
        _label = "DOESN'T SHIP ✗"
        print(f"\n  {red(bold(_label))}  Too many failures. This PR is not ready.")
...
def save_scorecard(checks: list, score: int, verdict: str, student_judgment: str):
    ...
    out_path = os.path.join(COMPETITIVE_DIR, "scorecard.json")
    with open(out_path, "w", encoding="utf-8") as f:
...
def main():
    ...
    print()
    print("Output files:")
    print(f"  devops_brain/challenge_pipeline.py")
    print(f"  devops_brain/competitive/code_review.json")
    print(f"  devops_brain/competitive/test_results.json")
    print(f"  devops_brain/competitive/slo_priority.json")
    print(f"  devops_brain/competitive/scorecard.json")
    print()
